    ...
    <el-col :span="12">
      ...
      >
        ...
        <el-form-item label="项目名" prop="name">
          <el-input v-model="prototype.name" maxlength="30"></el-input>
        </el-form-item>
        ...
        <el-form-item label="原型文件" prop="path">
          <el-switch
            ...
            <el-input v-model="prototype.path" v-show="useOutsidePath" placeholder="请输入外链地址"></el-input>
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: '请输入项目名（带版本号）', trigger: 'blur' },
        ...
        path: [
          { required: true, message: '请先上传文件/输入地址', trigger: 'change' }
        ],
      }
    }
  },
  methods: {
    ...
    submitForm() {
      this.$refs.form.validate((valid) => {
        ...
        POST('/api/prototype', this.prototype)
          .then(res => {
            this.resetForm()
